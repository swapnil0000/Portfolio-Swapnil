...
import back from "../pages/background.jpg";
...
const Banner = () => {
  ...
  return (
    <Box sx={{  animation: 'slideDown 1s ease',marginTop: '60px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '600px', backgroundImage: `url(${back})`, backgroundSize: 'cover' }}>
      <Box>
